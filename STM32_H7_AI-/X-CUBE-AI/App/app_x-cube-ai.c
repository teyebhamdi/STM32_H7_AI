...
/* USER CODE BEGIN 2 */
// Predefined input values for each example
const float predefined_inputs[] = {0.8f, 0.5f, 0.2f};
//const float predefined_inputs[] = {0.2f, 0.5f, 0.8f};
const int num_inputs = sizeof(predefined_inputs) / sizeof(predefined_inputs[0]);

// Corresponding text examples for each input value
const char* examples[] = {
    "The movie was great!",
    "The movie was okay.",
